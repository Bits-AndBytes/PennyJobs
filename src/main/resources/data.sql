...
VALUES ('johnsmith1@gmail.com','$2a$10$yK7cXzCyk2xIxwIvAZwvi.RKlaSMBuY1xXkxdNMKYyCQbVa2w.sBG','John', 'Smith', '123 Example St', 'Oakville', 'L6L 7U9', 'ON', '2005-11-17', 'S', 1);
...
UPDATE parent SET account_id = (SELECT id FROM account WHERE parent_id = 1);


--***JOB POSTER SAMPLE***
INSERT INTO job_poster (id) values (1);
...
UPDATE job_poster SET account_id = (SELECT id FROM account WHERE poster_id = 1);
